...
This project is Copyright (c) Christian Palmroos and licensed under
...
We love contributions! pyonset is open source,
...
pyonset based on its use in the README file for the
